...
export default function HostelPage({ params }: { params: Promise<{ id: string; collegeId: string }> }) {
    ...
    <div className="p-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        <div className="flex items-center space-x-4 mb-6">
          <HomeIcon className="w-10 h-10 text-teal-600" />
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Hostel Management</h1>
            <p className="text-gray-600 dark:text-gray-400">
              Room allocation, hostel attendance, and facilities for {college.name}
            </p>
          </div>
        </div>

        <div className="bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800 rounded-lg p-6 text-center">
          <HomeIcon className="w-16 h-16 text-teal-500 mx-auto mb-4" />
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
            Hostel Management - Coming Soon
          </h3>
          <p className="text-gray-600 dark:text-gray-400">
            This section will allow you to manage hostel facilities including:
          </p>
          <ul className="mt-4 text-left max-w-md mx-auto space-y-2 text-gray-700 dark:text-gray-300">
            <li>• Room Allocation and Availability</li>
            <li>• Hostel Attendance and Check-in/out</li>
            <li>• Mess and Food Management</li>
            <li>• Hostel Fee Collection</li>
            <li>• Warden and Staff Management</li>
            <li>• Complaints and Maintenance</li>
          </ul>
        </div>
      </div>
    </div>
