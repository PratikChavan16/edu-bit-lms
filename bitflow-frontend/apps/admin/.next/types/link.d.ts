...
declare namespace __next_route_internal_types__ {
  ...
  type DynamicRoutes<T extends string = string> = 
    | `/announcements/${SafeSlug<T>}/edit`
    | `/attendance/${SafeSlug<T>}/edit`
    | `/batches/${SafeSlug<T>}/edit`
    | `/colleges/${SafeSlug<T>}/edit`
    | `/courses/${SafeSlug<T>}/edit`
    | `/departments/${SafeSlug<T>}/edit`
    | `/exams/${SafeSlug<T>}/edit`
    | `/faculty/${SafeSlug<T>}/edit`
    | `/fees/${SafeSlug<T>}/edit`
    | `/results/${SafeSlug<T>}/edit`
    | `/students/${SafeSlug<T>}/edit`
    | `/subjects/${SafeSlug<T>}/edit`
    | `/timetable/${SafeSlug<T>}/edit`
    | `/universities/${SafeSlug<T>}/edit`
