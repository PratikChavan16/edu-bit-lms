...
"[project]/edu-bit-lms/bitflow-frontend/apps/admin/app/results/[id]/edit/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const resultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$edu$2d$bit$2d$lms$2f$bitflow$2d$frontend$2f$node_modules$2f2e$pnpm$2f$zod$40$3$2e$25$2e$76$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    marksObtained: __TURBOPACK__imported__module__$5b$project$5d2f$edu$2d$bit$2d$lms$2f$bitflow$2d$frontend$2f$node_modules$2f2e$pnpm$2f$zod$40$3$2e$25$2e$76$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].coerce.number().min(0),
    maxMarks: __TURBOPACK__imported__module__$5b$project$5d2f$edu$2d$bit$2d$lms$2f$bitflow$2d$frontend$2f$node_modules$2f2e$pnpm$2f$zod$40$3$2e$25$2e$76$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].coerce.number().min(1),
...
function EditResultPage() {
    ...
    const [isDeleting, setIsDeleting] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$edu$2d$bit$2d$lms$2f$bitflow$2d$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$6$2e$0$2d$canary$2e$49_react$2d$dom$40$19$2e$3$2e$0$2d$canary$2d$a4eb2dfa$2d$20251006_react$40$19$2e$3$2e$0$2d$canary$2d$a4eb2dfa$2d$_uc47x56iwmn47x4r5d6fvjqgzi$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const resultId = params.id;
    const { data: result, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$edu$2d$bit$2d$lms$2f$bitflow$2d$frontend$2f$node_modules$2f2e$pnpm$2f40$tanstack$2b$react$2d$query$40$5$2e$90$2e$2_react$40$19$2e$3$2e$0$2d$canary$2d$a4eb2dfa$2d$20251006$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "results",
            resultId
        ],
        queryFn: {
            "EditResultPage.useQuery": async ()=>{
                await new Promise({
                    "EditResultPage.useQuery": (resolve)=>setTimeout(resolve, 300)
                }["EditResultPage.useQuery"]);
                return mockResults.find({
                    "EditResultPage.useQuery": (r)=>r.id === resultId
                }["EditResultPage.useQuery"]);
            }
        }["EditResultPage.useQuery"]
    });
    ...
    const updateMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$edu$2d$bit$2d$lms$2f$bitflow$2d$frontend$2f$node_modules$2f2e$pnpm$2f40$tanstack$2b$react$2d$query$40$5$2e$90$2e$2_react$40$19$2e$3$2e$0$2d$canary$2d$a4eb2dfa$2d$20251006$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "EditResultPage.useMutation[updateMutation]": async (data)=>{
                await new Promise({
                    "EditResultPage.useMutation[updateMutation]": (resolve)=>setTimeout(resolve, 1000)
                }["EditResultPage.useMutation[updateMutation]"]);
                return data;
            }
        }["EditResultPage.useMutation[updateMutation]"],
        onSuccess: {
    ...
    const deleteMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$edu$2d$bit$2d$lms$2f$bitflow$2d$frontend$2f$node_modules$2f2e$pnpm$2f40$tanstack$2b$react$2d$query$40$5$2e$90$2e$2_react$40$19$2e$3$2e$0$2d$canary$2d$a4eb2dfa$2d$20251006$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "EditResultPage.useMutation[deleteMutation]": async ()=>{
                await new Promise({
                    "EditResultPage.useMutation[deleteMutation]": (resolve)=>setTimeout(resolve, 1000)
                }["EditResultPage.useMutation[deleteMutation]"]);
            }
        }["EditResultPage.useMutation[deleteMutation]"],
        onSuccess: {
            "EditResultPage.useMutation[deleteMutation]": ()=>{
    ...
    if (isLoading || !result) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$edu$2d$bit$2d$lms$2f$bitflow$2d$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$6$2e$0$2d$canary$2e$49_react$2d$dom$40$19$2e$3$2e$0$2d$canary$2d$a4eb2dfa$2d$20251006_react$40$19$2e$3$2e$0$2d$canary$2d$a4eb2dfa$2d$_uc47x56iwmn47x4r5d6fvjqgzi$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "p-6",
        children: "Loading..."
    }, void 0, false, {
        fileName: "[project]/edu-bit-lms/bitflow-frontend/apps/admin/app/results/[id]/edit/page.tsx",
        lineNumber: 89,
        columnNumber: 36
    }, this);
...
_s(EditResultPage, "cWgm1ekxPDIk+c1DcrtOuqR3bxg=", false, function() {
    return [
...
_c = EditResultPage;
var _c;
__turbopack_context__.k.register(_c, "EditResultPage");
...
//# sourceMappingURL=edu-bit-lms_bitflow-frontend_apps_admin_app_results_%5Bid%5D_edit_page_tsx_77816a5e._.js.map