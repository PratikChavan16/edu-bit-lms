...
"[project]/edu-bit-lms/bitflow-frontend/apps/admin/app/colleges/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CollegesPage() {
    ...
    const { data: colleges = [], isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$edu$2d$bit$2d$lms$2f$bitflow$2d$frontend$2f$node_modules$2f2e$pnpm$2f40$tanstack$2b$react$2d$query$40$5$2e$90$2e$2_react$40$19$2e$3$2e$0$2d$canary$2d$a4eb2dfa$2d$20251006$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'colleges',
            searchQuery,
            universityFilter
    ...
    const deleteMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$edu$2d$bit$2d$lms$2f$bitflow$2d$frontend$2f$node_modules$2f2e$pnpm$2f40$tanstack$2b$react$2d$query$40$5$2e$90$2e$2_react$40$19$2e$3$2e$0$2d$canary$2d$a4eb2dfa$2d$20251006$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "CollegesPage.useMutation[deleteMutation]": async (id)=>{
                // TODO: Replace with actual API endpoint
                // await fetch(`/api/colleges/${id}`, { method: 'DELETE' });
                console.log('Delete college:', id);
            }
        }["CollegesPage.useMutation[deleteMutation]"],
        onSuccess: {
            "CollegesPage.useMutation[deleteMutation]": ()=>{
...
_s(CollegesPage, "Xmra4/4+eSsuUbPtyye9VWBaLZk=", false, function() {
    return [
...
//# sourceMappingURL=edu-bit-lms_bitflow-frontend_04c88327._.js.map