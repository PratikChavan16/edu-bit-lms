...
export default function EditFacultyPage() {
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: FacultyFormData) => {
      ...
      console.log('Updating faculty:', facultyId, data);
  ...
  // Loading state
  if (loadingFaculty || loadingDepartments) {
    return (
    ...
    return (
      <div className="flex items-center justify-center p-8">
        <div className="text-center">
          <p className="text-red-500 mb-4">Faculty member not found.</p>
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold">Edit Faculty Member</h1>
        <p className="text-muted-foreground">Update the faculty member's information below.</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex gap-4">
          ...
          >
            {updateMutation.isPending ? "Updating..." : "Update Faculty Member"}
          </Button>
          <Button
            type="button"
            variant="secondary"
