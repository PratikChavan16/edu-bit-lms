...
export default function EditStudentPage({ params }: EditStudentPageProps) {
    ...
    queryFn: async () => {
      ...
      const mockStudents: Record<string, any> = {
        "1": {
          ...
          parent_email: "anil.sharma@example.com",
          guardian_relationship: "Father",
          emergency_contact: "+91 98765 22222",
          medical_info: "No known allergies",
          previous_education: "Delhi Public School, CBSE Board, 85%",
        },
        "2": {
          id: "2",
          student_id: "STU002",
          ...
          parent_email: "meera.patel@example.com",
          guardian_relationship: "Mother",
          emergency_contact: "+91 98765 22223",
          medical_info: "Allergic to peanuts",
          previous_education: "St. Xavier's School, ICSE Board, 92%",
        },
      };
      
      return mockStudents[studentId] || mockStudents["1"];
    },
  });
  ...
  if (error) {
    return (
      <div className="flex items-center justify-center p-8">
        <p className="text-red-500">Error loading student. Please try again.</p>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Update student information - {student?.first_name} {student?.last_name} ({student?.student_id})
          </p>
        </div>
